...
const CardScanner: React.FC = () => {
    ...
    return (
        <section className="relative w-full bg-[#150810] overflow-hidden" ref={containerRef}>
            <div className="container relative w-screen h-[400px] flex items-center justify-center">
                ...
                <div className="scanner hidden absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-1 h-[300px] rounded-[30px] bg-gradient-to-b from-transparent via-[#F472B6] to-transparent shadow-[0_0_20px_rgba(244,114,182,0.8),0_0_40px_rgba(244,114,182,0.4)] z-10 animate-scanPulse"></div>
